...
\end{par} \vspace{1em}
\begin{par}
We do have some overshoot here, which could be mitigated by incorporating a derivative term (PD control) We can also check that our simulink model agrees with our matlab simulations.
\end{par} \vspace{1em}
